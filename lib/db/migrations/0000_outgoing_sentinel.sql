CREATE TABLE `location` (
	...
	`lat` real NOT NULL,
	`long` real NOT NULL,
	`created_at` integer DEFAULT 1766280655357 NOT NULL,
	`updated_at` integer DEFAULT 1766280655357 NOT NULL
);
...
CREATE TABLE `locationLog` (
	...
	`created_at` integer DEFAULT 1766280655363 NOT NULL,
	`updated_at` integer DEFAULT 1766280655363 NOT NULL,
...
CREATE TABLE `locationLogImage` (
	...
	`created_at` integer DEFAULT 1766280655368 NOT NULL,
	`updated_at` integer DEFAULT 1766280655368 NOT NULL,
